...
| 功能                | 描述                                                                                                                                            |
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| **📸 空间影像生成** | 上传任意图片，基于 Apple ML-Sharp 自动生成 3D 高斯溅射模型，安装时预下载约 2.62 GiB 模型                                                        |
...
- 📥 **预下载模型** - 安装阶段即下载约 2.62 GiB 的推理模型，避免首次运行等待
...
2. **等待处理** - 观察队列区域的任务阶段（若安装阶段未完成下载，首次推理会下载约 2.62 GiB 的模型）
