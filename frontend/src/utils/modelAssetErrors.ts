...
const modelAssetErrorKeys: Record<string, string> = {
  ...
  invalid_model_asset_ids: 'modelAssetGenericError',
  model_asset_batch_too_large: 'modelAssetErrorBatchOperationTooLarge',
  model_asset_download_path_invalid: 'modelAssetErrorDownloadUnavailable',
  model_asset_download_unavailable: 'modelAssetErrorDownloadUnavailable',
  model_asset_download_insufficient_space: 'modelAssetErrorDownloadInsufficientSpace',
  model_asset_download_failed: 'modelAssetErrorDownloadUnavailable',
  model_asset_download_empty: 'modelAssetErrorDownloadEmpty',
  model_asset_download_not_found: 'modelAssetErrorDownloadUnavailable',
